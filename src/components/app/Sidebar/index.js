  ...
  return (
    <div className={s.sidebar}>
      ...
      <div className={s.logo}>
        <img src={require('../../../assets/images/logo.svg')} alt="Starflow"/>
      </div>
      ...
      <div className={s.socials}>
        <a href="https://t.me/starflow" target="_blank">
          <img src={require('../../../assets/images/social-icons/telegram.svg')}/>
        </a>
        <a href="https://www.facebook.com/starflowapp" target="_blank">
          <img src={require('../../../assets/images/social-icons/facebook.svg')}/>
        </a>
        <a href="https://twitter.com/starflowapp" target="_blank">
          <img src={require('../../../assets/images/social-icons/twitter.svg')}/>
        </a>
        <a href="https://medium.com/starflow" target="_blank">
